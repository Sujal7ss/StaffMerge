...
function Candidate({ candidate, job }) {
  ...
  //         `${process.env.REACT_APP_BACKENDURI}/api/candidate/resume/${candidate._id}`,
  //         { responseType: "blob" }
  //       );
  ...
  const handleYes = async() => {
    try{
      const {data} = await axios.get(`${process.env.REACT_APP_BACKENDURI}/api/employer/selectCandidate`,
        {
          params: {
            job: job,
            candidate: candidate
